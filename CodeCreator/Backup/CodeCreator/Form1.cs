...
namespace CodeCreator
{
    public partial class frm_Main : Form
    {
        ...
        private void btn_Connect_Click(object sender, EventArgs e)
        {
            ...
            string connsql = @"Data Source="+txt_ServerName.Text+";Initial Catalog=master;Integrated Security= True";
        ...
        {
            string strConn = @"Data Source=" + txt_ServerName.Text + ";Initial Catalog=" + databaseName + ";Integrated Security= True";
        ...
        private void btn_About_Click(object sender, EventArgs e)
        {
            MessageBox.Show(this,
                ...
                "C# ile uygulama yazarken CLASS yapılarında ve INSERT, UPDATE sorgularında yapılan basit hatalar çok zaman kaybettirebildiği için  ve Entity Framework'u kullanışlı bulmadığım için bu uygulamayı hazırladım.\n\n" +
